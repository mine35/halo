...
<section class="">
    <?php foreach ($buletin as $list) { ?>
        <div class="card mb-3" style="width: 82%; margin-top: 150px; margin-left: 130px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="<?php echo base_url('assets/images/berita/') . $list['image']; ?>" class="rounded-4" style="width: 250px; height: 250px; border-radius: 25px; ">
                </div>
                <div class="col-md-8">
