        ...
        <ul class="navbar-nav ml-auto" style="margin-top:25px;">
            <div class="collapse navbar-collapse" id="navbarNav" style="padding-right: -60px; font-family:poppins;">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url('auth/logout'); ?>" class="nav-link" style="color:#150544; "><b>Logout</b></a>
                    </li>
                </ul>
            </div>
        </ul>
...
<section class="" style="width:100%; height: 550px;">
    <div class="container" style="background-color: #150544; width:970px; height:110%; border-top-right-radius: 40px; margin-right:110px; margin-top:60px;">
