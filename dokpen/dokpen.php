...
<section class="" style="width:100%; height: 900px;">
    <div class="container" style="background-color: #150544; width:970px; height:600px; border-top-right-radius: 50px; margin-right:125px; margin-top:58px;">
        <h1 style="border-style: solid; width:58%; padding: 20px; border-radius:20px; color:white; margin-left:100px; margin-top:35px;">Dokumen Legal Pendukung</h1>
        ...
        <?php foreach ($dokpen as $list) { ?>
            <a href="<?php echo base_url('assets/dokpen/') . $list['isi']; ?>" style="font-size: 26px; color: white; font-family:poppins; margin: right 50%; margin-left:400px; margin-top:0px;"><?php echo $list['judul']; ?></a><br>
        <?php } ?>
    </div>
</section>
